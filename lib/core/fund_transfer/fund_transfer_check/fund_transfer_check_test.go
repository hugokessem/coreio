...
<S:Envelope xmlns:S="http://schemas.xmlsoap.org/soap/envelope/">
	...
	if result.Detail != nil {
		...
		assert.Equal(t, "ETB34.00", result.Detail.CreditAmountWithCurrency)
		assert.Equal(t, "ETB1.00", result.Detail.DebitAmountWithCurrency)
		...
		assert.Equal(t, "1025015557", result.Detail.DebitCustomerNumber)
		assert.Equal(t, "9999999999", result.Detail.CreditCustomerNumber)
